...
submitBtn.addEventListener("click", (event)=>{
    ...
    const delay1 = parseInt(document.querySelector('[name="delay"]').value);
    ...
    for(let index = 0; index < amount; index++){
        const currentDelay = delay1 + index * step;
        createPromise(index + 1, currentDelay).then(({ position , delay  })=>{
